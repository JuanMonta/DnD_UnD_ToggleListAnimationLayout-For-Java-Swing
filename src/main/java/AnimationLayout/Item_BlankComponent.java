...
/**
 * Componente que se usará y se identificará como un {@link ItemBlank} para el
 * layout {@link ToggleListAnimationLayout}.
 */
public class Item_BlankComponent extends ItemBlank {

    public Item_BlankComponent() {
        initComponents();
     ...
     * automáticamente desde {@link ItemBlank}
     *
     * @param imageIcon
     */
    @Override
